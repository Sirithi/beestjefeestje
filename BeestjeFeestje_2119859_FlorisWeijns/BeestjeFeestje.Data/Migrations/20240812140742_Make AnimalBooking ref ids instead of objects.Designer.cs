...
namespace BeestjeFeestje.Data.Migrations
{
    ...
    [Migration("20240812140742_Make AnimalBooking ref ids instead of objects")]
    partial class MakeAnimalBookingrefidsinsteadofobjects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeestjeFeestje.Data.Entities.AType", b =>
                {
            ...
            modelBuilder.Entity("BeestjeFeestje.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeestjeFeestje.Data.Entities.Animal", b =>
                {
                    b.HasOne("BeestjeFeestje.Data.Entities.AType", "AnimalType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BeestjeFeestje.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
